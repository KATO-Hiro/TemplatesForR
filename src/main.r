...
main <- function() {
  ...
  pdf_name <-  "./src/output/results-Ver.1.1"

  IS_OUTPUT_PDF <- FALSE # For dry run.

  pdf_creator_object <- pdf_creator$new(
    my_name = pdf_name
  )
...
run <- function() {
  log_info("Start calculations and drawings in the main study.")
  ...
  log_info("Calculations and drawings in the main study have been completed.")
}
